...
from src.utils.label_smoothing import CrossEntropyLoss
...
def weight_initialize(method: str, distribution: str, model):
...
class TransformerPL(pl.LightningModule):
    def __init__(self, cfg):
        ...
        weight_initialize(self.hp_trainer.weight_init, self.hp_trainer.weight_distribution, self.model)
